...
public class UIRenderer {
    ...
    public static void renderCheckbox(DrawContext context, int x, int y, int size, boolean enabled, Color borderColor, Color fillColor) {
        ...
        int bc = borderColor.getRGB();
        context.fill(x, y, x + size, y + 1, bc);
        context.fill(x, y + size - 1, x + size, y + size, bc);
        context.fill(x, y, x + 1, y + size, bc);
        context.fill(x + size - 1, y, x + size, y + size, bc);
    }
