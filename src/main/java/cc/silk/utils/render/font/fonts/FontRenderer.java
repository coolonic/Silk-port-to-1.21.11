...
import cc.silk.utils.render.font.util.BufferUtils;
import cc.silk.utils.render.font.util.Colors;
...
public class FontRenderer implements Closeable {
    ...
    public void drawString(MatrixStack stack, String s, float x, float y, Color color) {
        ...
        for (Identifier identifier : GLYPH_PAGE_CACHE.keySet()) {
            // RenderSystem.setShaderTexture() removed in 1.21.11 — texture binding now via pipeline.
            // TODO (Batch 3): bind texture through RenderPipeline sampler uniform.
            // GlStateManager._bindTexture() requires a GL int id, not an Identifier.
