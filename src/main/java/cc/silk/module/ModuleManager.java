...
import cc.silk.module.modules.combat.LungeSwap;
...
public final class ModuleManager {
    ...
    private void addModules() {
        ...
        // Movement
        add(new Sprint(), new AutoFirework(), new AutoHeadHitter(), new KeepSprint(), new SnapTap(), new LungeSwap());
        ...
        // Client
        add(new NewClickGUIModule(), new ClientSettingsModule(), new Client(),
